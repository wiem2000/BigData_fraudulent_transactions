...
public class FraudCategoryCounter {
    
        public static void main(String[] args) throws Exception {
        
            Configuration conf = new Configuration();
        Job job = Job.getInstance(conf, "fraud category counter");
        job.setJarByClass(FraudCategoryCounter.class);
        job.setMapperClass(CategoryFraudTokenizeMapper.class);
        ...
        if(job.waitForCompletion(true)){
            ...
            for (int i = 0; i < status.length; i++) {
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    Document doc = new Document("category", fields[0])
                    .append("fraud_count", Integer.parseInt(fields[1]));
                    docs.add(doc);
                ...
                if(!docs.isEmpty()){
                    ...
                    MongoCollection<Document> collection = database.getCollection("fraud_category_counts");
